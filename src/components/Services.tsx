      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {services.map((service, index) => (
            <Card key={index} className={`relative overflow-hidden transition-transform hover:scale-105 ${service.popular ? 'border-pink-500 border-2 shadow-lg' : 'border-gray-200'}`}>
              {service.popular && (
                <div className="absolute top-0 right-0 bg-pink-600 text-white px-3 py-1 text-sm font-medium">
                  Most Popular
                </div>
              )}
              ...
              <CardHeader className="text-center pb-4">
                ...
                <div className="text-3xl font-bold text-pink-600 mt-2">{service.price}</div>
