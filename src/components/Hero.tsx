...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-white to-pink-100">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="mb-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                ...
                <span className="text-pink-600 block">Relationships, Love, and Life</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button size="lg" className="bg-pink-600 hover:bg-pink-700 text-white px-8 py-3 rounded-full">
                Book Your Consultation
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
              <Button variant="outline" size="lg" className="border-pink-300 text-pink-700 hover:bg-pink-50 px-8 py-3 rounded-full">
                Watch My Content
          ...
          <div className="flex-1 flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 w-20 h-20 bg-pink-600 rounded-full flex items-center justify-center shadow-lg">
